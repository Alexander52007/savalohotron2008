...
class Room(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='owned_rooms', null=True, blank=True)
    ...
    def get_private_room(cls, user1, user2):
        ...
        if rooms.exists():
            return rooms.first()
        room = cls.objects.create(is_private=True, owner=user1)
